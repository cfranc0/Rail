...
public:
	...
	*/
	...
	/*setTrack
	* @param t, track
	* @throw InvalidTrackException, se il valore del binario � fuori dal range [0,6]
	*/
	void setTrack(int t);
	...
	*/
	...
	/**
	 * getMaxSpeed()
	 * @return la massima velocit� che il treno pu� raggiungere
	 */
